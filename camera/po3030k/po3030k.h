 ...
 *
 * To effectively write the register, you must call po3030k_write_cam_registers().
...
int main(void) {
        ...
        po3030k_init_cam();
        po3030k_config_cam((ARRAY_WIDTH -160)/2,(ARRAY_HEIGHT-160)/2,
                         160,160,4,4,RGB_565_MODE);
        po3030k_write_cam_registers();

        po3030k_launch_capture(buffer);
